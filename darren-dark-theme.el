(deftheme darren-dark
  "Created 2024-05-10.")

(custom-theme-set-faces
 'darren-dark
 '(default ((t (:family "Hack" :foundry "SRC" :width normal :height 98 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "grey80" :background "grey20" :stipple nil :inherit nil))))
 ...
 '(highlight ((((class color) (background dark)) (:background "midnight blue"))))
 ...
 '(font-lock-warning-face ((((class color) (min-colors 88) (background dark)) (:weight bold :foreground "yellow" :background "Red"))))
...
'(fringe ((((class color) (background light)) (:background "grey95")) (((class color) (background dark)) (:background "grey20")) (t (:background "gray"))))
'(header-line ((default (:inherit (mode-line))) (((type tty)) (:underline (:color foreground-color :style line :position nil) :inverse-video nil)) (((class color grayscale) (background light)) (:box nil :foreground "grey20" :background "grey90")) (((class color grayscale) (background dark)) (:box nil :foreground "grey90" :background "grey20")) (((class mono) (background light)) (:underline (:color foreground-color :style line :position nil) :box nil :inverse-video nil :foreground "black" :background "white")) (((class mono) (background dark)) (:underline (:color foreground-color :style line :position nil) :box nil :inverse-video nil :foreground "white" :background "black"))))
 ...
 '(mode-line ((t (:background "grey75" :foreground "black" :box (:line-width (1 . 1) :color "black" :style flat-button) :slant normal :weight regular :height 100 :width normal :foundry "PfEd" :family "DejaVu Sans Mono"))))

 '(mode-line-buffer-id ((t (:weight bold :foreground "gray80"))))
 ...
 ;'(mode-line-inactive ((t (:height 1.0 :weight light :box (:line-width (1 . 1) :color "#4E4E4C" :style nil) :foreground "#F0F0EF" :background "gray30" :inherit (mode-line)))))

 '(mode-line-active ((t (:inherit mode-line :background "blue violet" :box (:line-width (1 . 1) :color "black" :style flat-button)))))
 '(mode-line-inactive ((t (:inherit mode-line :background "gray40" :foreground "gray" :box (:line-width (1 . 1) :color "black" :style flat-button)))))
 '(fill-column-indicator ((t (:inherit shadow :foreground "gray24"))))
 ...
 '(line-number ((t (:inherit (shadow default) :background "gray20" :foreground "dim gray"))))
 '(vertical-border ((t (:foreground "gray90"))))
 '(line-number-current-line ((t (:inherit line-number :foreground "gray60" :weight bold))))
 '(query-replace ((t (:inherit (isearch))))))

(provide-theme 'darren-dark)
